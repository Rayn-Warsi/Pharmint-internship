...
## Corpus Check
- Corpus is ~39,388 words - fits in a single context window. You may not need a graph.
...
- Token cost: 222,367 input · 0 output
...
3. `main()` - 16 edges
4. `main()` - 15 edges
5. `score_counts()` - 15 edges
6. `fit_model_d_ab_gmm()` - 15 edges
7. `compute_entity_effects()` - 15 edges
...
## Knowledge Gaps
- **21 isolated node(s):** `add-watch.md Reference`, `exports.md Reference`, `extraction-spec.md Reference`, `github-and-merge.md Reference`, `query.md Reference` (+16 more)
...
- **What connects `add-watch.md Reference`, `exports.md Reference`, `extraction-spec.md Reference` to the rest of the system?**
